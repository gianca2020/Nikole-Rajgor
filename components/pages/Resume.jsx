      ...
      <section className="px-8 max-w-[1100px] mx-auto">
        <header className="mt-6 mb-12 flex flex-col items-center text-center">
          <div className="relative">
            ...
            <div className="absolute bottom-10 md:bottom-14 left-1/2 transform -translate-x-1/2 w-80 h-px bg-[#F6F1E8] header-line"></div>
          </div>
        </header>

        <div className="mb-12 text-white overflow-hidden">
          <iframe 
            src="/Nikole_resume.pdf" 
            className="w-full h-[600px] md:h-screen rounded border border-gray-600 scale-[0.6] md:scale-100 origin-top-left"
            style={{ width: 'calc(100% / 0.6)', height: 'calc(600px / 0.6)' }}
            title="Nikole Resume"
          />
        </div>
