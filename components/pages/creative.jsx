...
const Creative = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F6F1E8]">
      ...
      <section className="px-8 max-w-[1100px] mx-auto text-[#1F1F1F] min-h-screen mt-8 bg-[#F6F1E8]">
        <header className="mb-12 flex flex-col items-center text-center">
          <div className="relative">
            <h1 className="text-8xl md:text-9xl tracking-normal leading-[1.5]" style={{ fontFamily: 'Italianno, cursive', letterSpacing: '0.08em', fontWeight: '50', color: '#1F1F1F' }}>Creative</h1>
            <div className="absolute bottom-10 md:bottom-14 left-1/2 transform -translate-x-1/2 w-80 h-px bg-[#1F1F1F] header-line"></div>
          </div>
        </header>
